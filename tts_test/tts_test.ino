...
// TTS keys
static const u1_t PROGMEM DEVEUI[8] = { 0x16, 0xBF, 0x06, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 }; // lsb format
static const u1_t PROGMEM APPEUI[8] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; // lsb format
static const u1_t PROGMEM APPKEY[16] = { 0xA9, 0x05, 0x25, 0x13, 0xE7, 0x0A, 0x1A, 0xB1, 0x4D, 0xDC, 0x0D, 0xBF, 0x34, 0x02, 0x14, 0xB7 }; // msb format
